...
func (m *MigrationState) markComplete() {
	m.persistedState.CurrentBucketPath = migrationCompleteMarker
...
// newChunk creates a new chunk for the migration.
...
func (v *VerificationState) markComplete() {
	v.persistedState.CurrentBucketPath = verificationCompleteMarker
